...
\begin{tabular}{>{\raggedright}L!{\VRule}R}
	\hspace{-1mm}{5/22 - present} & {\textbf{UXly Software\textbullet\ Partner \textbullet\ Palo Alto, CA}} \\
    & {\textbullet\ Bootstrapped & brought to market 1Shot API product. } \\
\end{tabular}

\begin{tabular}{>{\raggedright}L!{\VRule}R}
	\hspace{-1mm}{5/22 - 11/24} & {\textbf{Snickerdoodle Labs\textbullet\ CTO \textbullet\ Palo Alto, CA}} \\
